...
<div class="container" style="width: 80%">
  ...
  <form class="form-group" action="customersearch.php" method="post" style="margin-right: 50px; ">
  <div class="row">
  <div class="col-md-10"><input type="text" name="search" class="form-control" placeholder="Search by Customer Name"></div>
  <div class="col-md-2"><input type="submit" name="customer_search" class="btn btn-light" value="Search"> </div></div>           
  </form>
  </span>
  <br>
