...
<div class="container" style="width: 80%">
  ...
  <table class="table table-hover">
      <thead>
        ...
        <?php
        if(isset($_POST['payment_search'])){
            $payment_id=$_POST['search'];
    ...
    <a href="databasepayment.php" class="btn btn-light" style="background-color:#3498DB;color:FFFFFF">Go Back</a>
  </div>