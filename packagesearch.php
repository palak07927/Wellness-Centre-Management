...
<div class="container" style="width: 80%">
  ...
  <table class="table table-hover">
      <thead>
        ...
        <?php
        if(isset($_POST['package_search'])){
            $package_name=$_POST['search'];
            $query="select * from package1 where package_name='$package_name'";
    ...
    <a href="databasepackage.php" class="btn btn-light" style="background-color:#3498DB;color:FFFFFF">Go Back</a>
  </div>