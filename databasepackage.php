...
<div class="container" style="width: 80%">
  <br>
  <br>
  <span style="font-size: 50px; font-weight: 400; color: white;">Package Details</span>
  <span style="float : right; margin-top: 25px;">
  <form class="form-group" action="packagesearch.php" method="post" style="margin-right: 50px;" >
  <div class="row">
  <div class="col-md-10"><input type="text" name="search" class="form-control" placeholder="Search by Package Name"></div>
  <div class="col-md-2"><input type="submit" name="package_search" class="btn btn-light" value="Search"> </div></div>           
  </form>
  </span>
  <br>
            ...
            <?php
              ...
              if(mysqli_num_rows($result)>0){
                ...
                <tr style="color: rgb(240,240,240);">
                  ...
                  <td><a class="btn btn-primary" href="editpackage.php?package_id=<?php echo $package['package_id']; ?>" role="button">Edit Details</a></td>
                  <td><a class="btn btn-danger" href="delete_package.php?package_id=<?php echo $package['package_id']; ?>" role="button">Delete Details</a></td>
                </tr>
              <?php }
              }else {
