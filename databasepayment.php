...
<div class="container" style="width: 80%">
  <br>
  <br>
  <span style="font-size: 50px; font-weight: 400; color: white;">Payment Details</span>
  <span style="float : right; margin-top: 25px;">
  <form class="form-group" action="paymentsearch.php" method="post" style="margin-right: 50px; ">
  <div class="row">
  <div class="col-md-10"><input type="text" name="search" class="form-control" placeholder="Search by Transaction ID"></div>
  <div class="col-md-2"><input type="submit" name="payment_search" class="btn btn-light" value="Search"> </div></div>           
  </form>
  </span>
  <br>
            ...
            <?php
              ...
              if(mysqli_num_rows($result)>0){
                ...
                <tr style="color: rgb(240,240,240);">
                  ...
                  <td><a class="btn btn-primary" href="editpayment.php?payment_id=<?php echo $payment['payment_id']; ?>" role="button">Edit Details</a></td>
                  <td><a class="btn btn-danger" href="delete_payment.php?payment_id=<?php echo $payment['payment_id']; ?>" role="button">Delete Details</a></td>
                </tr>
              <?php }
              }else {
