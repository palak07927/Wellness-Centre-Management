...
<div class="container" style="width: 80%">
  <br>
  <br>
  <span style="font-size: 50px; font-weight: 400; color: white;">Trainer Details</span>
  <span style="float : right; margin-top: 25px;">
  <form class="form-group" action="trainersearch.php" method="post" style="margin-right: 50px; ">
  <div class="row">
  <div class="col-md-10"><input type="text" name="search" class="form-control" placeholder="Search by Trainer Name"></div>
  <div class="col-md-2"><input type="submit" name="trainer_search" class="btn btn-light" value="Search"> </div></div>           
  </form>
  </span>
  <br>
      ...
      <thead>
        ...
        if(mysqli_num_rows($result)>0){
          ...
          <tr style="color: rgb(240,240,240);">
            ...
            <td><?php echo $trainer['trainer_emailid']; ?></td>
            <td><?php echo $trainer['trainer_phoneno']; ?></td>
            <td><a class="btn btn-primary" href="edittrainer.php?trainer_id=<?php echo $trainer['trainer_id']; ?>" role="button">Edit Details</a></td>
            <td><a class="btn btn-danger" href="delete_trainer.php?trainer_id=<?php echo $trainer['trainer_id']; ?>" role="button">Delete Details</a></td>
          </tr>
        <?php }
        }else {
